  ...
  return (
    <Container className="mainSection">
      <Card className="card ms-auto my-4 p-4 bg-light bg-opacity-75">
        <Card.Header className="display-4 mt-3" as="h1">
          Login
        </Card.Header>
        <Card.Body>
              ...
              <Form.Control
                ...
                {...register("clave", {
                  ...
                  pattern: {
                    ...
                    message:
                      "La contraseña puede tener de 8 a 64 caracteres y contiene una mezcla de mayusculas y minusculas, un numero y un caracter especial",
                  },
                })}
              />
              <Form.Text className="text-danger">
